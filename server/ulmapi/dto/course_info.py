...
class CourseInfo(Model):
    ...
    def course_id(self, course_id):
        ...
        if course_id is not None and not re.search(r'[a-z0-9]+', course_id):  # noqa: E501
            raise ValueError("Invalid value for `course_id`, must be a follow pattern or equal to `/[a-z0-9]+/`")  # noqa: E501
