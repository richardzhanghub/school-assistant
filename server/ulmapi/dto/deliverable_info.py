...
class DeliverableInfo(Model):
    ...
    def __init__(self, deliverable_id=None, deliverable_name=None, grade=None, weight=None, due_at=None, completed=None):  # noqa: E501
        """DeliverableInfo - a model defined in OpenAPI

        :param deliverable_id: The deliverable_id of this DeliverableInfo.  # noqa: E501
    ...
    def deliverable_id(self):
        """Gets the deliverable_id of this DeliverableInfo.


        :return: The deliverable_id of this DeliverableInfo.
        :rtype: str
        """
        return self._deliverable_id

    @deliverable_id.setter
    def deliverable_id(self, deliverable_id):
        """Sets the deliverable_id of this DeliverableInfo.


        :param deliverable_id: The deliverable_id of this DeliverableInfo.
        :type deliverable_id: str
        """
        if deliverable_id is not None and len(deliverable_id) < 1:
            raise ValueError("Invalid value for `deliverable_id`, length must be greater than or equal to `1`")  # noqa: E501
        if deliverable_id is not None and not re.search(r'[a-z0-9]+', deliverable_id):  # noqa: E501
            raise ValueError("Invalid value for `deliverable_id`, must be a follow pattern or equal to `/[a-z0-9]+/`")  # noqa: E501
