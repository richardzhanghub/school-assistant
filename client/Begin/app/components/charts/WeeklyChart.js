...
export default class WeeklyChart extends React.Component {
  constructor(props) {
    ...
    courses.forEach((course, i) => {
      ...
      if (i < 3) {
        data = [
          this.sumHours(course.time_spent, 0),
          this.sumHours(course.time_spent, 1),
          this.sumHours(course.time_spent, 2),
          this.sumHours(course.time_spent, 3),
          this.sumHours(course.time_spent, 4),
          this.sumHours(course.time_spent, 5),
          this.sumHours(course.time_spent, 6),
        ];
        // console.log(data)
        switch (i) {
          case 1:
